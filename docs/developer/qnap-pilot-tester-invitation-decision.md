...
Use this guide before inviting early external stakeholder organization testers to the QNAP-hosted CCLD
...
- Confirm that tester invitation is an explicit decision before early external stakeholder organization
  users are invited.
- Confirm that the pilot remains a public-interest hobby project, not a the user's employer
  project.
