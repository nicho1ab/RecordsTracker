...
- `gap.data.facility.facility_fixture_ccld_program_facilities_tiny.complaint_info_date_sub_aleg_inc_aleg_uns_aleg_typea_typeb.extracted_canonical_mapping_missing`
...
- `gap.data.facility.facility_fixture_ccld_program_facilities_tiny.inspection_visit_dates.extracted_canonical_mapping_missing`
...
- `gap.data.facility.facility_fixture_ccld_program_facilities_tiny.other_visit_dates.extracted_canonical_mapping_missing`
...
- `gap.data.facility.facility_fixture_chhs_facility_master_tiny.client_served.extracted_canonical_mapping_missing`
