...
| `data.complaint.complaint.agency_name` | complaint | complaint normalizer: agency_name | `not allocated` | not displayed | `EXTRACTED_CANONICAL_MAPPING_MISSING` | P1 |
...
| `data.complaint.complaint.complaint_report_contact` | complaint | complaint normalizer: complaint_report_contact | `not allocated` | not displayed | `EXTRACTED_CANONICAL_MAPPING_MISSING` | P1 |
...
| `data.complaint.complaint.deficiency_texts` | complaint | complaint normalizer: deficiency_texts | `not allocated` | not displayed | `EXTRACTED_CANONICAL_MAPPING_MISSING` | P1 |
...
| `data.complaint.complaint.investigation_findings_narrative` | complaint | complaint normalizer: investigation_findings_narrative | `not allocated` | not displayed | `EXTRACTED_CANONICAL_MAPPING_MISSING` | P1 |
...
| `data.complaint.raw_complaint_report.agency_name` | complaint | AGENCY | `not allocated` | not displayed | `EXTRACTED_CANONICAL_MAPPING_MISSING` | P1 |
...
| `data.complaint.raw_complaint_report.deficiency_text` | complaint | DEFICIENCIES | `not allocated` | not displayed | `EXTRACTED_CANONICAL_MAPPING_MISSING` | P1 |
...
| `data.facility.raw_complaint_report.facility_contact` | facility | TELEPHONE | `not allocated` | not displayed | `EXTRACTED_CANONICAL_MAPPING_MISSING` | P1 |
