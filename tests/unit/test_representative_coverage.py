...
def _insert_live_batch_and_job(
    ...
    *,
    ...
    _insert_import_batch(connection, record_counts=record_counts)
    _insert_retrieval_job(connection, result_counts=result_counts)
    ...
    *,
    ...
    return {
        ...
        "source_traceability": {
            ...
            "connector_version": "test",
            "retrieved_at": DEFAULT_RETRIEVED_AT,
            "source_artifact_identity": DEFAULT_ARTIFACT_IDENTITY,
        },
    }
