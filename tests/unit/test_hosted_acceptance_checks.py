...
def test_verify_script_checks_complete_tester_readiness_route_set() -> None:
    ...
    for route_name in (
        ...
        "facility-licensing-activity",
        "facility-complaint-trends",
        "facility-hub",
        "record-request",
    ...
    for route_path in (
        ...
        'Path = "/ccld/facilities/intelligence?view=licensing-visit-activity"',
        'Path = "/ccld/facilities/intelligence?view=complaint-activity-over-time"',
        'Path = "/ccld/facilities/detail?facility_number=$PreloadedFacilityNumber"',
        'Path = "/ccld/records/request"',
        'Path = "/reviewer"',
        'Path = "/reviewer/records"',
        'Path = "/reviewer/records/matrix.csv?$contextQuery"',
