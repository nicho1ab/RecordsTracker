...
REQUIRED_CONTENT = {
    ...
    "PUBLIC_SOURCE_DATA_INVENTORY.md": [
        ...
        "CalHHS/CHHS Community Care Licensing Facilities dataset",
        ...
        "Future CSV handling must preserve at least source URL when known",
    ...
    "docs/developer/hosted-scaffold.md": [
        ...
        "does not persist reviewer-created state",
