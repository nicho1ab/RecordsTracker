...
function Test-Issue417RouteAssertions {
    ...
    Add-Issue417PassFail -Assertions $Assertions -RouteName $name -Check "issue417 concepts labeled" -Pass ($Text.Contains("Source category") -and $Text.Contains("Review topic") -and $Text.Contains("Possible keyword cue")) -PassMessage "Source category, review topic, and possible keyword cue labels found." -FailMessage "One or more serious-topic concept labels missing."
    ...
    if ($kind -eq "default") {
        ...
        Add-Issue417PassFail -Assertions $Assertions -RouteName $name -Check "issue417 category/cue wording" -Pass ($Text.Contains("Source category") -and $Text.Contains("Review topic") -and $Text.Contains("Possible keyword cue")) -PassMessage "Serious-topic concept labels found." -FailMessage "Category/topic/cue separation wording missing."
